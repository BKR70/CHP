<?php 
	...
	$query = mysqli_query($conn, "select * from emp_post where id = 5");
...
<body style = "background-color:cyan" >
    <div class="container light-style flex-grow-1 container-p-y">
        ...
        <div class="text-right mt-3">
			<?php if(isset($_SESSION['four'])) { ?>
				<button type="button" ><a href="../Employees.php" onclick="fk()">Hire Me</a></button>
			<?php } else if(isset($_SESSION['techGiantmail'])) { $_SESSION['four'] = "ok";
