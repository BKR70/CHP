<?php 
	...
	if( isset($_SESSION['Categore']) ){
		$var = $_SESSION['Categore'];
		$query = "select JobId, title, company, wtype, officelocation, location, jtype from posttable where category='$var'";
	}
	else {
		$query = "select JobId, title, company, wtype, officelocation, location, jtype from posttable";
	}
...
<body>
    <div class="nav">
		<ul>
		  ...
		  <?php if(isset($_SESSION['uname'])) { ?>
			<li style="float:right"><a class="active" href="listlogout.php"> Log Out</a></li>
	...
	<div class="container" style="">
        <h1 style="border-bottom:1px dotted black; padding-bottom:20px;"> ``Job Listings``</h1>
